...
class HED(nn.Module):
    ...
    def forward(self, x):
        ...
        dsn1_final = self.crop_layer(dsn1, h,
                                     w)
        ...
        if self.cfg.MODEL.upsample_layer == 'deconv':
            ...
            if not self.cfg.MODEL.upsample_positive:
                weight_deconv2 = -weight_deconv2
